...
PRESENCE_ARRIVAL_SCANS = int(os.getenv("SIGNALLY_PRESENCE_ARRIVAL_SCANS", "2"))
PRESENCE_DEPARTURE_GRACE_SECONDS = int(
    os.getenv("SIGNALLY_PRESENCE_DEPARTURE_GRACE_SECONDS", "90")
)
...
EVENT_FAMILY_MEMBER_ENTERED = "FAMILY_MEMBER_ENTERED"
EVENT_FAMILY_MEMBER_LEFT = "FAMILY_MEMBER_LEFT"
